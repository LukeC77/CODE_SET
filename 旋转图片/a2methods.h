...
//This defines a macro A2, 
//which will be replaced by A2Methods_UArray2 
//during the preprocessing stage.
#define A2 A2Methods_UArray2


//This line of code defines an alias A2 of type void *.
//The purpose of this is to make A2 represent a pointer to 
//an unknown type.
typedef void *A2;               /* unknown type that represents a 
                                 * 2D array of 'cells'
                                 */
//Such a definition is syntactically legal, 
//but it does not actually define any new types. 
//void means "no type" in C language 
//and cannot be used to define specific variables or objects.
...
//This line of code cancels the previously defined macro A2, 
//making macro A2 no longer valid outside the header file.
#undef A2
